...
execute_process(
  COMMAND "/usr/bin/git" show-ref "release-0.0.4"
  WORKING_DIRECTORY "/workspaces/robot-test/build/_deps/replxx-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/release-0.0.4")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "release-0.0.4")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "release-0.0.4")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/AmokHuginnsson/replxx.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/robot-test/build/_deps/replxx-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/robot-test/build/_deps/replxx-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
